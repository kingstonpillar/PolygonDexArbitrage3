...
// === Utility for Token Hub (include WMATIC or POL dynamically, no duplicates) ===
function getHubTokens() {
  const lastToken = process.env.HUB_TOKEN_4 || process.env.GAS_TOKEN || "0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270"; // fallback WMATIC
