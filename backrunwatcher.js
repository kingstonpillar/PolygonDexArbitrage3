...
// === Utility for Token Hub (include WMATIC or POL dynamically, lowercase, unique, safe) ===
function getHubTokens() {
  // Determine the last token dynamically (WMATIC or GAS_TOKEN)
  const lastToken = process.env.HUB_TOKEN_4 || process.env.GAS_TOKEN || "0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270";

  // Collect all hub tokens
  const tokens = [
  ...
  // Filter out any undefined, null, or empty strings, then lowercase and remove duplicates
